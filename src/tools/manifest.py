...
mcp_tool_list: list[dict[str, object]] = [
    ...
    {"name": "rag_refresh_tool_catalog", "description": "Builds/refreshes internal RAG tool catalog from the active MCP tool manifest.", "inputSchema": {"type": "object", "properties": {}, "required": []}},
    {"name": "rag_list_tool_catalog", "description": "Lists known tools grouped by family for RAG filtering.", "inputSchema": {"type": "object", "properties": {"tool_family": {"type": "string", "description": "Optional family filter, e.g. microsoft/filesystem/shell."}}, "required": []}},
    {"name": "rag_upsert_document", "description": "Creates or updates one RAG knowledge document tied to a tool family/name.", "inputSchema": {"type": "object", "properties": {"doc_id": {"type": "string"}, "title": {"type": "string"}, "content": {"type": "string"}, "tool_family": {"type": "string"}, "tool_name": {"type": "string"}, "provider": {"type": "string", "default": "microsoft"}, "doc_type": {"type": "string", "default": "reference"}, "source_url": {"type": "string"}, "version": {"type": "string"}, "tags": {"type": "array", "items": {"type": "string"}}}, "required": ["doc_id", "title", "content", "tool_family"]}},
    {"name": "rag_delete_document", "description": "Deletes one RAG knowledge document by id.", "inputSchema": {"type": "object", "properties": {"doc_id": {"type": "string"}}, "required": ["doc_id"]}},
    {"name": "rag_list_documents", "description": "Lists stored RAG documents with optional filters.", "inputSchema": {"type": "object", "properties": {"tool_family": {"type": "string"}, "tool_name": {"type": "string"}, "provider": {"type": "string"}, "doc_type": {"type": "string"}, "limit": {"type": "integer", "default": 100}}, "required": []}},
    {"name": "rag_search_tool_guidance", "description": "Searches RAG documentation for actionable tool guidance.", "inputSchema": {"type": "object", "properties": {"query": {"type": "string"}, "tool_family": {"type": "string"}, "tool_name": {"type": "string"}, "provider": {"type": "string"}, "doc_type": {"type": "string"}, "top_k": {"type": "integer", "default": 5}, "min_score": {"type": "number", "default": 0.2}}, "required": ["query"]}},
    {"name": "rag_get_tool_execution_guidance", "description": "Returns condensed execution guidance and cited sources for a specific tool intent.", "inputSchema": {"type": "object", "properties": {"tool_name": {"type": "string"}, "intent": {"type": "string"}, "provider": {"type": "string"}, "top_k": {"type": "integer", "default": 3}}, "required": ["tool_name", "intent"]}},
    ...
    {"name": "microsoft_onenote_list_notebooks", "description": "Lists OneNote notebooks for the signed-in user (requires Notes.Read or Notes.ReadWrite on the token).", "inputSchema": with_graph({"type": "object", "properties": {"top": {"type": "integer"}}, "required": []})},
    {"name": "microsoft_onenote_list_sections", "description": "Lists sections in a OneNote notebook by notebook id.", "inputSchema": with_graph({"type": "object", "properties": {"notebook_id": {"type": "string"}, "top": {"type": "integer"}}, "required": ["notebook_id"]})},
    {"name": "microsoft_onenote_list_pages", "description": "Lists pages in a OneNote section by section id.", "inputSchema": with_graph({"type": "object", "properties": {"section_id": {"type": "string"}, "top": {"type": "integer"}}, "required": ["section_id"]})},
    {"name": "microsoft_onenote_get_page_content", "description": "Fetches OneNote page body as HTML (GET /me/onenote/pages/{id}/content).", "inputSchema": with_graph({"type": "object", "properties": {"page_id": {"type": "string"}, "max_chars": {"type": "integer"}}, "required": ["page_id"]})},
